...
class WhatsAppQRPopup(models.TransientModel):
    ...
    # Computed field for countdown display - UNUSED (commented in view)
    ...
    # UNUSED METHOD - Commented out (has commented write statement)
    ...
    #         if not popup:
    #             _logger.warning(f"No QR popup found for socket update")
    #             return False
    #         
    #         # Extract QR data
    #         qr_img = qr_data.get('qrCode') or qr_data.get('qr_img') or qr_data.get('qr_code_image')
    #         if not qr_img:
    #             _logger.warning(f"No QR image data in socket event")
    #             return False
    #         
    ...
    #         
    #     except Exception as e:
    #         _logger.error(f"Error updating QR from socket: {e}")
    #         return False
    ...
    #         
    #         if not qr_code:
    #             _logger.warning(f"No QR code data in socket event")
    #             return False
    #         
    #         # Ensure base64 prefix
    ...
    #         
    #     except Exception as e:
    #         _logger.error(f"Error in handle_socket_qr_update: {e}")
    #         return False

    # UNUSED METHOD - Commented out (has commented write statement, not called)
    ...
    #             
    #         if not popup:
    #             _logger.warning(f"No QR popup found for phone mismatch event")
    #             return False
    #         
    ...
    #             }
    #         else:
    #             _logger.warning(f"No QR code in phone mismatch event")
    #             return False
    #         
    #     except Exception as e:
    #         _logger.error(f"Error handling phone mismatch event: {e}")
    #         return False
    ...
    def _handle_status_event(self, status_data):
        ...
        try:
            ...
            # UNUSED STATUS HANDLERS - Commented out
            # elif status_type == 'qr_code_mismatch':
            #     _logger.warning(f"Phone mismatch detected")
            ...
            #     _logger.warning(f"WhatsApp disconnected")
    ...
    def do_something(self, data):
        ...
        try:
            ...
            # Handle phone mismatch events - UNUSED
    ...
    # UNUSED METHODS - Commented out (buttons commented in view)
    # def action_continue(self):
    #     """Continue after QR scan and proceed with sending messages"""
    #     self.ensure_one()
    #     
    #     if not self.original_wizard_id:
    #         _logger.error(f"Original wizard data not found for popup ID: {self.id}")
    ...
    # UNUSED METHOD - Commented out (only called by action_refresh_qr which is unused)
    # def _generate_new_qr_code(self):
    #     """Generate new QR code from API"""
    #     try:
    #         if not self.api_key or not self.phone_number:
    #             _logger.error(f"Missing API key or phone number for QR generation")
    ...
    #                 
    #                 # Update current popup with new QR code - UNUSED (commented out)
    #                 # self.write({
    ...
    #                 # })
    #                 
    #                 _logger.info(f"New QR code generated for {self.from_number}")
    #                 
    #                 # Show notification
    #                 return {
    #                     'type': 'ir.actions.client',
    ...
    #                 _logger.error(f"QR generation failed: {error_msg}")
    #                 raise UserError(_("Failed to generate QR code: %s") % error_msg)
    #         else:
    #             _logger.error(f"QR generation API returned error code: {response.status_code}")
    #             raise UserError(_("API returned status %d") % response.status_code)
    #             
    #     except requests.exceptions.Timeout:
    #         self.retry_count += 1
    #         _logger.warning(f"QR generation timeout, retry count: {self.retry_count}")
    #         
    ...
    #             }
    #         else:
    #             _logger.error(f"Maximum retries reached for QR generation")
    #             raise UserError(_("Maximum retries reached. Please refresh the page."))
    #     except Exception as e:
    #         _logger.error(f"Error generating new QR code: {e}")
    #         raise UserError(_("Failed to generate QR code: %s") % str(e))
    
    # UNUSED METHODS - Commented out (only called from commented controller code)
